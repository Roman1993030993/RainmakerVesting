...
const lockupTime = 8 * 30 * day; // 8 months
const period = 1; // 1 seconds 
const duration = 40 * 30 * day; // lockupTime 32 months + 8 months = 40 months
...
contract("TestRainVestingStrategic.test", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    vestingSettings = {
      ...
      lockupTime: lockupTime, // 8 months
      percentAfterCliff: 0,
      duration: duration // lockupTime 32 months + 8 months = 40 months
    };
