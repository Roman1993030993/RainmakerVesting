...
const lockupTime = 4 * 30 * day; // 8 months
const period = 1; // 1 seconds 
const duration = 21 * 30 * day; // lockupTime 17 months + 4 months = 21 months
...
contract("TestRainVestingT2.test", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    vestingSettings = {
      ...
      percentAfterCliff: 0,
      duration: duration // lockupTime 17 months + 4 months = 21 months
    };
