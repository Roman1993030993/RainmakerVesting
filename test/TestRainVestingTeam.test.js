...
const duration = 36 * 30 * day; // lockupTime 24 months + 12 months = 36 months
...
contract("TestRainVestingTeam", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    vestingSettings = {
      ...
      percentAfterCliff: 0,
      duration: duration // lockupTime 24 months + 12 months = 36 months
    };
