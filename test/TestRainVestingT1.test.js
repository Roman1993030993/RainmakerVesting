...
const lockupTime = 6 * 30 * day; // 8 months
const period = 1; // 1 seconds 
const duration = 30 * 30 * day; // lockupTime 24 months + 6 months = 30 months
...
contract("TestRainVestingT1.test", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    vestingSettings = {
      ...
      percentAfterCliff: 0,
      duration: duration // lockupTime 24 months + 6 months = 30 months
    };
