...
const lockupTime = 12 * 30 * day; // 12 months
const period = 1; // 1 seconds 
const duration = 48 * 30 * day; // lockupTime 36 months + 1 years = 48 months
...
contract("TestRainVestingSeed.test", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    vestingSettings = {
      ...
      lockupTime: lockupTime, // 12 months
      percentAfterCliff: 0,
      duration: duration // lockupTime 36 months + 1 years = 48 months
    };
