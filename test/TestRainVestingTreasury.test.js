...
const lockupTime = 1 * day; // 1 months
const period = 1; // 1 seconds 
const duration = 24 * 30 * day; // lockupTime 24 months + 0 month = 24 months
...
contract("TestRainVestingTreasury.test", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    vestingSettings = {
      ...
      percentAfterCliff: 0,
      duration: duration // lockupTime 24 months + 0 month = 24 months
    };
