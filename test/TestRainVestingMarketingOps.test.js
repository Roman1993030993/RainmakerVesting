...
const duration = 37 * 30 * day; // lockupTime 36 months + 1 month = 37 months
...
contract("TestRainVestingMarketingOps.test", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    vestingSettings = {
      ...
      percentAfterCliff: 0,
      duration: duration // lockupTime 36 months + 1 years = 17 months
    };
